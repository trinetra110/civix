    ...
    switch (status) {
      ...
      case "InProgress":
        return {
          ...
          icon: <div className="w-4 h-4 bg-blue-600 rounded-full flex items-center justify-center">
  ...
  if (grievances.length === 0) {
    return (
      <div className="text-center py-16">
        ...
        <h3 className="text-xl font-semibold text-gray-900 mb-2">No grievances yet</h3>
        <p className="text-gray-600 mb-6">
          You haven't submitted any grievances. Click the button above to get started.
        </p>
      </div>
    );
  }
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pt-4 border-t border-gray-100">
                <div className="flex items-center space-x-6 text-sm text-gray-500">
                  <div className="flex items-center space-x-2">
                    ...
                    <span>
                      Submitted: {new Date(grievance.submittedAt).toLocaleDateString('en-US', {
                        month: 'short',
                        day: 'numeric',
                        year: 'numeric'
                      })}
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span>
                      Updated: {new Date(grievance.lastUpdated).toLocaleDateString('en-US', {
                        month: 'short',
                        day: 'numeric',
                        year: 'numeric'
                      })}
                ...
                {grievance.fileUrls && grievance.fileUrls.length > 0 && (
                  <div className="flex items-center space-x-2 text-sm text-blue-600">
                    ...
                    <span>{grievance.fileUrls.length} attachment{grievance.fileUrls.length > 1 ? 's' : ''}</span>
                  </div>
                )}
              </div>
            </div>
